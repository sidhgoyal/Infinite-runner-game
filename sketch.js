...
function preload() {
  ...
  retartImg = loadImage("restart.png");
}
...
function setup() {
  ...
  retart = createSprite(displayWidth / 2, 40 + displayHeight / 10);
  retart.addImage(retartImg);


  retart.scale = 0.5;


  retart.visible = false;
